...
class read(object):
  ...
  def findsmiles(self,line):
      words = line.split()
      if words[0] == '>smiles':
        return words[1]
  
  def addfragment(self,bins,intensity,position):
      row.append(position)
      col.append(bins)
      data.append(intensity)
  
  def get_col_index(self,mz_value):
      temp_value = mz_value
      col_index1 = 0
