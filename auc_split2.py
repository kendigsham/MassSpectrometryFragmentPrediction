...
def split_list(tasknum_mzvalue,num_of_chunks):
  list_of_lists = numpy.array_split(numpy.array(tasknum_mzvalue.keys()),num_of_chunks)
  return list_of_lists
...
def read_n_auc( smile_latent_csv, mol2filter, chunk_num, num_of_chunks):
  model_name = 'rbf'
  ...
  list_of_lists = split_list(tasknum_mzvalue,num_of_chunks)
...
num_of_chunks = sys.argv[2]
number = int(temp_number) -1
print type(num_of_chunks)


#read_n_auc('gnps_smiles_2_latent.csv', 5, number, num_of_chunks)
