...
def openfile (filename,position):
    ...
    smile_row[canonicalised_smiles] = position
    unique_smiles[canonicalised_smiles] = 1
...
#    sp.save_npz(filename3,classmatrix)
    return classmatrix, mz_value_colindex, smile_row, rowindex_smile, unique_smiles
#    
