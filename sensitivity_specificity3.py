...
#%%
#mz_values = mz_value_list.get_mz_list('massbank_result2.csv', 20, 10,0.8)
#print 'mz_value', len(mz_values)
#
#unique_smiles_all = get_unique_smiles()
#print 'unique_smiles', len(unique_smiles_all)
...
everything('gnpsresult2.csv', 20, 10, 0.7,'ranked_sen_spec_gnps.csv')

#with open('smile_nosenspec_gnps.txt','w') as fff:
#  pickle.dump(smile2no_sen_spec,fff)
#  
#with open('smile_binary_true.txt','w') as f1:
#  pickle.dump(smile_binary_true,f1)
#
#with open('smile_binary_predict.txt','w') as f2:
#  pickle.dump(smile_binary_predict,f2)
#  
#with open('mzvalue_binarycolumn.txt','w') as f3:
#  pickle.dump(mzvalue_binarycolumn,f3)
#  
#with open('smile_sensitivity.txt','w') as f4:
#  pickle.dump(smile_sensitivity,f4)
#  
#with open('smile_specificity.txt','w') as f5:
#  pickle.dump(smile_specificity,f5)
#  
#with open('smile_confusion.txt','w') as f6:
#  pickle.dump(smile_confusion,f6)
#
...
##
#p_values.save_lists(sen_row,spec_row,'sen_row_gnps.txt','spec_row_gnps.txt')
#p_values.save_lists(sen_column,spec_column,'sen_column_gnps.txt','spec_column_gnps.txt')
#
...
#
#p_values.save_lists(smile_sen_pvalues_row,smile_spec_pvalues_row,'smile_sen_pvalues_row_gnps.txt','smile_spec_pvalues_row_gnps.txt')
#p_values.save_lists(smile_sen_pvalues_column,smile_spec_pvalues_column,'smile_sen_pvalues_column_gnps.txt','smile_spec_pvalues_column_gnps.txt')
##
##
##
#with open ('ranked_sen_spec_gnps.csv','r') as f:
#  list_of_list=[]
#  for line in f:
...
#
#df.to_csv('ranked_sen_spec_p_value_gnps2massbank.csv',index=False)
#
...
#import pickle
#
#with open('smile_sen_pvalues_row.txt','r') as f1:
#  smile_sen_pvalues_row = pickle.load(f1)
#  
#with open('smile_spec_pvalues_row.txt','r') as f2:
#  smile_spec_pvalues_row = pickle.load(f2)
#  
#with open('smile_ssen_pvalues_column.txt','r') as f3:
#  smile_ssen_pvalues_column = pickle.load(f3)
#  
#with open('smile_spec_pvalues_column.txt','r') as f4:
