          ...
          if len(line)>2:
            ...
            if canonicalised_smiles ==None:
              ...
              if bins !=0 and intensity !=0:
                ...
                if temp_mz_2_numofmol.get(mz_value) ==None:
                  temp_mz_2_numofmol[mz_value] =1
                  if mz_2_numofmol.get(mz_value)==None:
                    mz_2_numofmol[mz_value] = 1
                  else:
                    mz_2_numofmol[mz_value]+=1
...
#    sp.save_npz(filename3,classmatrix)
    return classmatrix, mz_value_colindex, row_file, file_smile, rowindex_smile, mz_2_numofmol
#    
